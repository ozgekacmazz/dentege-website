...
import {
    FaTooth, FaGem, FaMagic, FaLayerGroup, FaImage, FaUserMd,
    FaHeartbeat, FaChild, FaSmile, FaMedkit
} from 'react-icons/fa';
...
const Treatments = () => {
    const allTreatments = [
        ...
        },
        {
            ...
            icon: <FaTooth /> // Reusing Tooth ideally different
        },
        {
            id: "pedodonti",
                    ...
                    >
                        <div>
                            ...
                            <p style={{ color: 'var(--color-text-light)', marginBottom: '0.75rem' }}>
                                Protetik diş tedavisinde (porselen, zirkonyum, laminate veneer vb.) artık klasik
                                manuel ölçüler yerine tamamen bilgisayar ve yapay zeka destekli dijital ölçü alıyoruz.
                            </p>
                            <p style={{ color: 'var(--color-text-light)' }}>
                                Dijital ölçü sayesinde sapma oranlarını ve tekrar ölçü alma ihtiyacını en aza indirirken,
                                tedavi sürecini de kısaltmış oluyoruz. Bu süreci, dijital ölçü alanında dünya çapında
                                lider kabul edilen <strong>3Shape</strong> teknolojisi ile gerçekleştiriyoruz.
                            </p>
                        </div>
                        <div
                            style={{
                ...
                <section style={{ marginTop: '4rem' }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <p style={{ color: 'var(--color-text-light)' }}>
                                İmplant uygulaması, lokal anestezi altında yapılır ve işlem sırasında ağrı hissetmeniz
                                beklenmez. Sonrasında oluşabilecek hafif hassasiyetler, hekiminizin önereceği ağrı
                                kesicilerle genellikle kısa sürede kontrol altına alınır.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p style={{ color: 'var(--color-text-light)' }}>
                                Uzman diş hekimi kontrolünde ve uygun dozlarda yapılan profesyonel beyazlatma işlemi,
                                diş minesine zarar vermez. İşlem sonrası geçici hassasiyet görülebilir, bu durum genelde
                                kısa sürelidir ve koruyucu ürünlerle desteklenir.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p style={{ color: 'var(--color-text-light)' }}>
                                Ortodontik tedavi sadece çocuklara özel değildir; diş ve diş eti sağlığı uygun olan her
                                yaştaki bireyde uygulanabilir. Erişkin hastalar için de tel tedavisi veya şeffaf plak
                                seçenekleri ile estetik ve fonksiyonel sonuçlar almak mümkündür.
                            </p>
                        </div>
                        ...
                        >
                            <h3 style={{ marginBottom: '0.5rem' }}>
                                Çocuğumu ilk ne zaman diş hekimine götürmeliyim?
                            </h3>
                            <p style={{ color: 'var(--color-text-light)' }}>
                                İlk süt dişinin sürmesinden itibaren, en geç 1 yaş civarında çocukların diş hekimi
                                kontrolüne getirilmesi önerilir. Erken dönemde yapılan kontroller, hem çürüklerin önüne
                                geçmeye hem de çocukların diş hekimine alışmasına yardımcı olur.
                            </p>
                        </div>
                    </div>
                </section>
